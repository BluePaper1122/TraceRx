...
- Fresh `python -m tracerx.evaluation`: **6/6 scenario states, 165/165 compared parser fields, 15/15 exact documents**. The 15 documents belong to six patients, not 15 independent risk cases.
